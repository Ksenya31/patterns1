...
public class DataGenerator {
    ...
    public static String generateCity() {
        ...
        final String [] citiesAdministrativeCenters = new String [] {"Новотроицк", "Горно-Алтайск", "Уфа", "Улан-Удэ",
                "Махачкала", "Орск", "Москва", "Черкесск", "Петрозаводск", "Сыктывкар", "Симферополь",
